...
این صفحه شما را قادر می‌سازد تا تنظیمات سبک فونت را برای عنوان صفحه و مسیر سایت صفحه تنظیم کنید.
...
می توانید تنظیمات سبک فونت متفاوتی را برای عنوان صفحه و مسیرِ صفحهِ طرح بندی "Banner Condensed" اختصاص دهید.
...
برگه "Buttons" در مدیریت سبک ها به شما اجازه می‌دهد تا متغیرهای اختصاص داده شده به همه دکمه‌های مورد استفاده در صفحات قالب لاگوم را پیکربندی کنید.
...
- "Large" - عمدتاً در صفحات "سایت" مانند صفحه اصلی، صفحات تبلیغاتی و همچنین برای نوارهای فرعی خلاصه در طول فرآیند سفارش استفاده می شود. در آن بخش ها، می توانید تنظیمات سبک فونت را برای هر اندازه دکمه تغییر دهید. می‌توانید آزادانه از میان مقادیر از پیش تعریف‌شده‌ای که در تب [تایپوگرافی](/lagom/style-manager#tapywgrafy) در مدیریت سبک های لاگوم پیکربندی شده‌اند، انتخاب کنید.

اگر می‌خواهید ارتفاع هر دکمه را پیکربندی کنید، به تب [عمومی](/lagom/style-manager#emwmy) در مدیریت سبک لاگوم بروید و مقادیر را برای [UI Elements Height](/lagom/style-manager#ui-elements-height) تنظیم کنید.
...
- "Light" - برای پس زمینه های "Secondary" و "Primary" استفاده می شود.
  ...
  قالب لاگوم هیچ سبک دکمه دیگری را اعمال نمی کند، با این حال، آنها می توانند توسط ماژول های WHMCS استفاده شوند، بنابراین امکان مدیریت این دکمه ها نیز ارائه داده شده است.
