...
این ویژگی مختص قالب لاگوم و سایت ساز لاگوم است، در فرم سفارش یک مرحله‌ای لاگوم کاربرد ندارد. برای جزئیات بیشتر، به [نکات سازگاری](#fraynd-sfarsh) مراجعه کنید.
{% /callout %}
