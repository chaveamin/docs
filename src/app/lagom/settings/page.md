...
برای حفظ ثبات و اطمینان از نمایش مناسب توضیحات محصول، همانطور که در مثال زیر نشان داده شده است، از کد HTML زیر در تمام صفحات لاگوم استفاده میشود. کد را بدون فاصله پیست کنید

<!-- prettier-ignore -->
```html
<p>این یک نوشته آزمایشی است که به طراحان و برنامه نویسان کمک میکند.</p><ul class="package-features"><li>Website<b>نامحدود</b></li><li><b>50 گیگابایت</b>حافظه NVME</li><li>پهنای باند<b>نامحدود</b></li><li>ایمیل<b>نامحدود</b></li><li>گواهی SSL<b>رایگان</b></li><li class="premium-divider"><span>ویژگی های اختصاصی</span></li><li>بکاپ<b>هفتگی</b></li><li>سرور<b>سریع</b></li><li>پشتیبانی<b>24 ساعته</b></li></ul>
```
