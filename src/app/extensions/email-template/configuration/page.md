...
3. **Translate** - به شما امکان میدهد محتوای فیلد را به چندین زبان ترجمه کنید - [اطلاعات بیشتر](#trjmh-ha).
...
بخش کپی رایت به شما امکان میدهد متن حق کپی رایت نمیاش داده شده در فوتر ایمیل را تعریف کنید. همچنین میتوانید به راحتی این متن را همانطور که در [اینجا](#trjmh-ha) توضیح داده شده است، ترجمه کنید.
...
3. **Translate** - با کلیک روی "Translate"، یک پنجره‌ باز میشود که میتوانید ترجمه‌ی نام لینک را در آن وارد کنید. برای اطلاعات بیشتر به بخش [ترجمه‌ی](#trjmh-ha) مراجعه کنید.
...
فونت مورد استفاده در قالب ایمیل مستقیماً از تنظیمات دسته ["تایپوگرافی"](/lagom/style-manager#tapywgrafy) در مدیریت استایل، همانطور که در زیر نشان داده شده است، گرفته میشود:
![تنظیمات افزونه](/mail/email_template-templates-5.png)

##### رنگ فونت ها

رنگ‌های فونت زیر در قالب‌های ایمیل، بر اساس تنظیمات ["تایپوگرافی"](/lagom/style-manager#tapywgrafy) استفاده میشوند:
![تنظیمات افزونه](/mail/email_template-templates-6.png)

##### اندازه فونت

قالب‌های ایمیل از تنظیم اندازه فونت "Medium" برای تمام متن بدنه، بر اساس پیکربندی بخش ["تایپوگرافی"](/lagom/style-manager#tapywgrafy) در مدیریت استایل، استفاده میکنند:
![تنظیمات افزونه](/mail/email_template-templates-7.png)

##### اندازه های عنوان

هر متن عنوانی که در پیام‌های ایمیل شما استفاده میشود، از تنظیمات اندازه عنوان پیکربندی شده در متغیرهای ["تایپوگرافی"](/lagom/style-manager#tapywgrafy) پیروی خواهد کرد:
![تنظیمات افزونه](/mail/email_template-templates-8.png)

## بومی سازی

### ترجمه ها {% version v="2.0.0" %}{% /version %}

از نسخه **2.0.0** به بعد، تمام فیلدهای متنی که میتوانند در افزونه قالب ایمیل لاگوم پیکربندی شوند، اکنون به راحتی قابل ترجمه هستند. کافیست روی دکمه **"Translate"** در کنار هر فیلد کلیک کنید، که پنجره‌ای را باز میکند که تمام زبان‌های موجود در سیستم WHMCS شما را نمایش میدهد، همانطور که در زیر نشان داده شده است:
![تنظیمات افزونه](/mail/email_template-translate-1.png)
این ویژگی با اطمینان از اینکه مشتریان ایمیل‌هایی با عنوان‌ها و متن پاورقی به زبانی که به حساب کاربری آنها اختصاص داده شده است، دریافت میکنند، تجربه چندزبانگی را تا حد زیادی بهبود میبخشد.

به عنوان مثال، اگر زبان پیشفرض سیستم WHMCS شما **فارسی** باشد، اما یک مشتری زبان **انگلیسی** را برای پورتال مشتری خود انتخاب کرده باشد، ایمیل به طور خودکار از مقادیر وارد شده در فیلد ترجمه **انگلیسی** استفاده میکند

### پشتیبانی از راست چین {% version v="2.0.0" %}{% /version %}

با معرفی ویژگی‌های ترجمه در نسخه **2.0.0**، مفتخریم که **پشتیبانی کامل از RTL (راست چین)** را برای ایمیل اعلام کنیم، **چیزی که قبلاً به صورت بومی در WHMCS وجود نداشت!** قالب‌های ایمیل لاگوم اکنون **بطور خودکار** تشخیص میدهند که آیا زبان انتخابی مشتری LTR است یا RTL و طرح ایمیل را بر اساس آن تنظیم میکنند و یک تجربه کاملاً بومی‌سازی شده و حرفه‌ای را تضمین میکنند.

اگر مشتری یک زبان راست چین را انتخاب کند، مانند:

- Arabic
- Farsi (Persian)
- Hebrew

طراحی ایمیل به طور سازگار به طرح‌ بندی راست چین تغییر میکند و پیامی کاملاً تراز شده و خوانا ارائه میدهد، همانطور که در مثال زیر نشان داده شده است:
![تنظیمات افزونه](/mail/email-integration-default-rtl.png)
به لطف این ویژگی، ارتباط شما واقعاً جهانی میشود - بدون نیاز به هیچ گونه تنظیم دستی یا کدنویسی!

## آپلود لوگو

به محض فعال شدن افزونه قالب ایمیل، کادرهای لوگوی جدید در تب ["Branding"](#) قالب لاگوم نمایش داده میشوند.

{% video src="/mail/upload_logo.mp4" %}{% /video %}